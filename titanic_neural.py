...
#test
X_test_nn = X_test.T
W1_test = param_cache["W1"][-1]
W2_test = param_cache["W2"][-1]
b1_test = param_cache["b1"][-1]
b2_test = param_cache["b2"][-1]
...
y_pred_t = y_pred_t.T   
np.save('C:\\Users\\maksim.lebedev\\Desktop\\MachineLearning\\Kaggle\\Titanic\\W1_1hl_relu_20l_26f', W1)
np.save('C:\\Users\\maksim.lebedev\\Desktop\\MachineLearning\\Kaggle\\Titanic\\W2_1hl_relu_20l_26f', W2)
np.save('C:\\Users\\maksim.lebedev\\Desktop\\MachineLearning\\Kaggle\\Titanic\\b1_1hl_relu_20l_26f', b1)
np.save('C:\\Users\\maksim.lebedev\\Desktop\\MachineLearning\\Kaggle\\Titanic\\b2_1hl_relu_20l_26f', b2)

submission = pd.DataFrame({
        "PassengerId": test["PassengerId"],
        "Survived": y_pred_t[:, 0]
    })
submission.to_csv('C:\\Users\\maksim.lebedev\\Desktop\\MachineLearning\\Kaggle\\Titanic\\submission_nn_15.csv', 
                  index = False)
